...
fn main() {
    ...
    for i in 1..11 {
        ...
        let a_position = i % 2 == 0; // looking for job
        let a_criteria = [true; NUM_CRITERIA]; // what they match
        let a_salary: u8 = thread_rng().gen_range(0..100); // requesting 1 million
        ...
        let b_position = i % 2 != 0; // hiring
        let b_criteria = [true; NUM_CRITERIA];
        let b_salary: u8 = thread_rng().gen_range(101..200); // can pay up to 1.5 million
